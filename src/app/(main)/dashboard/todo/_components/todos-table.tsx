            ...
            <TableBody>
              {data?.data.map((todo) => (
                <TableRow key={todo.id}>
                  ...
                  <TableCell className={todo.completed ? "text-muted-foreground line-through" : ""}>
                    {todo.title}
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge className={priorityColors[todo.priority || "medium"]}>{todo.priority || "medium"}</Badge>
                  </TableCell>
                  <TableCell>{todo.dueDate ? format(new Date(todo.dueDate), "MMM d, yyyy") : "-"}</TableCell>
                  <TableCell>{format(new Date(todo.createdAt), "MMM d, yyyy")}</TableCell>
                  <TableCell>
                    <Button variant="ghost" size="icon" onClick={() => deleteMutation.mutate({ id: todo.id })}>
